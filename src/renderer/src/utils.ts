...
export const DEFAULT_ICON: IconName = 'user'

export const DEFAULT_ACCOUNTS: Omit<Account, 'id'>[] = [
  { name: 'Personal', emoji: 'user', color: '#25D366', order: 0, pinned: false },
  { name: 'Work', emoji: 'briefcase', color: '#128C7E', order: 1, pinned: false },
]
